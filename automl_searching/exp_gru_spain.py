...
from utils import SpainDataLoader, TSF_Data, TSF

dataloader = SpainDataLoader(data_path="/home/andrew/Time Series/dataset/Spain_Energy_Consumption")

result_path = "spain/spain_result_gru" # saving the processing of training phase and images ploted
num_features = 1
...
for output_width in [60]:
    ...
    # tsf = TSF(data=dataloader.consumptions.loc[:, 20],batch_size=32, shift=1, shuffle=False, input_width=input_width, label_width=output_width)
